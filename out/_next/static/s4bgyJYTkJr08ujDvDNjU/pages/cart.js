  ...
  [12],
  {
    ...
    Jwq0: function (e, t, a) {
      ...
      ;(Q.handledProps = ['as', 'children', 'className', 'content']),
        (Q.propTypes = {}),
        (Q.create = Object(S.d)(Q, function (e) {
          return { content: e }
        }))
      var q = Q,
        Z = a('3WF5'),
      ...
      ;(H.handledProps = ['as', 'children', 'className', 'content']),
        (H.propTypes = {}),
        (H.defaultProps = { as: 'li' }),
        (H.create = Object(S.d)(H, function (e) {
          return { content: e }
        }))
      var W = H
      function F(e) {
        ...
        return c.a.createElement(
          s,
          d()({}, i, { className: r }),
          v.b.isNil(t) ? D()(n, W.create) : t
        )
      }
      ;(F.handledProps = ['as', 'children', 'className', 'items']),
        (F.propTypes = {}),
        (F.defaultProps = { as: 'ul' }),
        ...
        X = function (e) {
          ...
          if (0 === t.length)
            return B(
              ...
              B(R.Header, null, 'Your cart is empty'),
              B(
                'p',
                null,
    ...
    QetY: function (e, t, a) {
              ...
              },
              {
                ...
                value: function () {
                  var e = this.props,
                    ...
                    Z = Object(K.a)(t, this.props, this.computeElementType),
                    D = this.computeTabIndex(Z)
                  if (!g()(f)) {
                    var H = k()('ui', J, 'button', l),
                      W = k()('ui', M, 'button', l, Q),
                      F = Y.a.create(f, {
                        defaultProps: {
                          basic: !0,
                    ...
                    return T.a.createElement(
                      Z,
                      c()({}, q, { className: W, onClick: this.handleClick }),
                      'left' === j && F,
                      T.a.createElement(
                        E.a,
                        { innerRef: this.ref },
                  ...
                  var L = k()('ui', J, Q, M, 'button', l),
                    R = !w.b.isNil(s),
                    _ = this.computeButtonAriaRole(Z)
                  return T.a.createElement(
                    E.a,
                    { innerRef: this.ref },
                    T.a.createElement(
                      ...
                      c()({}, q, {
                        className: L,
                        'aria-pressed': A ? !!a : void 0,
                        disabled: (p && 'button' === Z) || void 0,
                        onClick: this.handleClick,
                        role: _,
                        tabIndex: D,
                      }),
                      R && s,
                      !R && G.a.create(v, { autoGenerateKey: !1 }),
                      !R && u
                    )
                  )
                },
      ...
      f()(H, 'defaultProps', { as: 'button' }),
        ...
        (H.propTypes = {}),
        (H.create = Object(z.d)(H, function (e) {
          return { content: e }
        }))
      var W = (t.a = H)
    },
