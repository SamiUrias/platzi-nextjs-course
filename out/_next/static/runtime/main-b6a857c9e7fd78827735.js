  ...
  [7],
  {
    ...
    IKlv: function (e, t, n) {
      ...
      var k = C.props,
        ...
        j = D || ''
      ;(n.p = ''.concat(j, '/_next/')),
        R.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: A || {} })
      var q = (0, T.getURL)(),
        O = new b.default(F, j),
        H = function (e) {
          var t = f(e, 2),
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 29:
                      return (
                        (t.router = X = (0, v.createRouter)(N, M, q, {
                          initialProps: k,
                          pageLoader: O,
                          App: V,
                          Component: Y,
                        ...
                        Q({ App: V, Component: Y, props: k, err: c }),
                        e.abrupt('return', $)
                      )
                    case 35:
                      e.next = 37
              ...
              value: function (e, t) {
                ...
                return Promise.all(
                  document.querySelector(
                    ...
                    ? []
                    : [
                        v(r, d, r.match(/\.css$/) ? 'style' : 'script'),
                        !t &&
