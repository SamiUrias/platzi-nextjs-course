    ...
    Ri3X: function (t, e, r) {
      ;(function (t) {
        !(function () {
          ...
          ;[].keys &&
            ('next' in (we = [].keys())
              ? (Se = Re(Re(we))) !== Object.prototype && (be = Se)
              : (_e = !0)),
            null == be && (be = {}),
            S(be, Pe) ||
              I(be, Pe, function () {
          ...
          var Ie = { IteratorPrototype: be, BUGGY_SAFARI_ITERATORS: _e },
            Te = _.f,
            Me = Dt('toStringTag'),
            ke = function (t, e, r) {
              t &&
          ...
          var ao = wr(
            ...
            so = function (t, e) {
              ...
              return a.length
                ? r.length
                  ? ((o = new ao(r.concat(a))), mr(o, (i = []).push, i), i)
                  : a
                : r
            }
          It(
                ...
                [
                  ...
                  function (t, o) {
                    ...
                    for (var p = 0, h = 0, d = []; h < u.length; ) {
                      f.lastIndex = bi ? h : 0
                      var v,
                        g = li(f, bi ? u : u.slice(h))
                      if (
                        null === g ||
                        (v = mi(ct(f.lastIndex + (bi ? 0 : h)), u.length)) === p
                      )
                        h = fi(u, h, s)
                      else {
          ...
          if (
              ...
              ba = function () {
                var t =
                    arguments.length < 1 || void 0 === arguments[0]
                      ...
                      : String(arguments[0]),
                  e =
                    this instanceof ba ? new ya(t) : void 0 === t ? ya() : ya(t)
                return '' === t && (ma[e] = !0), e
              }
            wt(ba, ya)
            ...
            ga(Sa, 'description', {
              ...
              It({ global: !0, forced: !0 }, { Symbol: ba })
          }
          Bi('hasInstance'),
          ...
          Lu ||
            ...
            Mu
              ...
              ? ((Eu = !0),
                ...
                new _u(mu).observe(xu, { characterData: !0 }),
                (wu = function () {
                  xu.data = Eu = !Eu
                }))
              : Tu && Tu.resolve
          ...
          ;(bc.prototype = qt(Error.prototype, {
            ...
            a &&
              _.f(bc.prototype, 'errors', {
                get: function () {
                  return mc(this).errors
                },
                configurable: !0,
              }),
            It({ global: !0 }, { AggregateError: bc }),
            It(
              { target: 'Promise', stat: !0 },
              {
                try: function (t) {
